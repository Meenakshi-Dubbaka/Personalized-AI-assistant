    ...
    <div className="chatwindow">
      <div className="navbar">
        ...
        <div className="usericondiv">
          <span className="usericon" onClick={handleProfile}>
            <i
              className="fa-solid fa-circle-user"
              style={{ color: " #74C0FC", fontSize: "1.25rem" }}
            ></i>
      ...
      <div className="chatinput">
        ...
        <p className="info">
          MayaAI can make mistakes. check important info. see{" "}
          <a className="cookies">cookies prefernces</a>.
        </p>
      </div>
    </div>
  );
